...
class Settings(BaseSettings):
    ...
    # Call `settings.validate()` after construction (or from
    ...
    def validate_security(self) -> None:
        ...
        This is the cycle-5 fail-fast gate. Call this from
        `create_app()` so a misconfigured production deploy exits
